                ...
                <div className="flex items-center space-x-4">
                  <div
                    ...
                    dangerouslySetInnerHTML={{
                      __html: renderRichText(member.details)!,
                    }}
                  />
                </div>
              )}
...
const TeamMembers: React.FC<TeamMembersProps> = ({ teamData }) => {
  ...
  // Handle case where teamData is empty
  if (!teamData?.length) {
    return (
    ...
    <div className="min-h-screen">
      <div className="py-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="hidden lg:block lg:w-1/2 max-w-xl sticky top-0 h-fit">
            <div className="bg-white overflow-hidden">
              <div className="relative">
                <Image
                  src={`https:${selectedMember.image}`}
                  ...
                  {selectedMember.details && (
                    <div className="flex items-center space-x-4">
                      <div
                        className="prose md:prose-base max-w-none"
                        dangerouslySetInnerHTML={{
                          __html: renderRichText(selectedMember.details)!,
                        }}
                      />
                    </div>
                  )}
