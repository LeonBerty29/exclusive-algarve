        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="grid grid-cols-5 gap-3 py-4">
            ...
            >
              ...
              <span className="text-xs font-medium hidden lg:block">Facebook</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium hidden lg:block">Telegram</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium hidden lg:block">Twitter</span>
            </button>
            ...
            >
              ...
              <span className="text-xs font-medium hidden lg:block">{t("copy")}</span>
            </button>
          </div>
