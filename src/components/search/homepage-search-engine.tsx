...
import { ScrollToFilters } from "./scroll-to-view";
...
export const HomepageSearchEngine = async ({
  ...
  return (
    <>
      ...
      {/* Client component to handle scrolling when filters are active */}
      {hasFilters && <ScrollToFilters />}
      <div
        id="search-filters-section"
        className="w-full max-w-6xl mx-auto p-4 sm:p-6 bg-black/30 shadow-lg"
      >
        <div className="flex flex-col gap-4 lg:flex-row lg:gap-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-1">
            ...
            <div className="relative">
              ...
              >
                <ListPropertyTypes
                  typologies={propertyAggregrators.typologies}
                />
              </Suspense>
            </div>
            ...
            <div className="relative">
              ...
              >
                <ListBedroomsRangeSelect
                  bedroomsRange={propertyAggregrators.bedrooms}
                />
              </Suspense>
            </div>
            ...
            <div className="relative">
              ...
              >
                <ListBathroomsRangeSelect
                  bathroomsRange={propertyAggregrators.bathrooms}
                />
              </Suspense>
            </div>
          </div>
