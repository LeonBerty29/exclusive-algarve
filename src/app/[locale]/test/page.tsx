...
export default function ReceiptGenerator() {
  ...
  const receiptData = {
    ...
    items: [
      ...
      { name: "Service Fee", quantity: 1, price: 15.0 },
    ],
    tax: 0.1,
  ...
  const handlePrint = () => {
    ...
    // Create a data URL with the complete HTML
    const printContent = `
      <!DOCTYPE html>
      <html>
        <head>
          ...
          <table className="w-full mb-8">
            <thead>
              <tr className="border-b-2 border-gray-300">
                ...
                <th className="text-center py-3 text-gray-700 font-semibold">
                  Qty
                </th>
                <th className="text-right py-3 text-gray-700 font-semibold">
                  Price
                </th>
                <th className="text-right py-3 text-gray-700 font-semibold">
                  Total
