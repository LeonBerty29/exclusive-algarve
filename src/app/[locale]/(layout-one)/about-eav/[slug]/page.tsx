...
import { resourcesPageMetadata } from "@/seo-metadata/about-eav-resources-metadata";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    const metadata =
      resourcesPageMetadata[locale as keyof typeof resourcesPageMetadata] ||
      resourcesPageMetadata.en;
    ...
    const resourcesPath = routing.pathnames["/about-eav/[slug]"];
    ...
    const defaultImage = `${BASE_URL}/images/eav-dark-logo.png`; // Adjust path to your actual logo location
