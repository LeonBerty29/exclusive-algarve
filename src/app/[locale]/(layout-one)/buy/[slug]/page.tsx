...
import { buyResourcesPageMetadata } from "@/seo-metadata/buy-resources";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    const metadata =
      buyResourcesPageMetadata[locale as keyof typeof buyResourcesPageMetadata] ||
      buyResourcesPageMetadata.en;
    ...
    const resourcesPath = routing.pathnames["/buy/[slug]"];
