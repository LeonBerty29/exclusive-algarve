...
import { sellResourcesPageMetadata } from "@/seo-metadata/sell-resource";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    ...
    const metadata =
      sellResourcesPageMetadata[locale as keyof typeof sellResourcesPageMetadata] ||
      sellResourcesPageMetadata.en;
    ...
    const resourcesPath = routing.pathnames["/sell/[slug]"];
