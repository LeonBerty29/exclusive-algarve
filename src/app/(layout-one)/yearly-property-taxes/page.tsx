        ...
        <div>
            <div className='lg:container mx-auto px-6 md:px-12 lg:px-14 py-14 xl:pb-20'>
                <div className='flex items-center gap-y-5 justify-between py-5 md:py-8 flex-wrap'>
                    ...
                    <Image src='/images/banner-digital-nomad.png' width={1513} height={622} alt='about-us' className='object-cover w-full h-72 md:w-[50%] lg:w-[47%] 2xl:w-[44%] xl:h-[390px] md:h-auto' />
                </div>
            </div>
            <div className='lg:container mx-auto px-6 md:px-12 lg:px-14 py-14 xl:pb-20'>
                <div className='mb-10'>
