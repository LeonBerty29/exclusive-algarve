import ExampleUsage from "@/components/brochure/dynamic-brochure-pdf";
...
//       </div>
//       {/* Property Type */}
//       <div className="flex flex-col items-center py-10 mb-8 bg-black text-white">
...
//               the main entrance, the hall leads you to the living room and
//               dining area, towards the kitchen.
//             </p>
//           </div>
...
//       <div className="mt-10">
//         <p className="font-medium text-2xl text-primary mb-5">
//           DRIVING DISTANCE
//         </p>
